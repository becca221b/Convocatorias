...
namespace Convocatorias.Application.Interfaces.Repositories
{
    public interface IPostulacionRepository
    {
        ...
        Task<IReadOnlyCollection<Postulacion>> GetAllAsync(CancellationToken ct = default);
        Task<IReadOnlyCollection<Postulacion>> GetPostulacionesByConvocatoriaIdAsync(Guid convocatoriaId, CancellationToken ct = default);
